...
| Area | Deliverable |
|---|---|
| UPDATE Preview | Persist the three baseline tokens in canonical JSON before hash |
...
| External link | In-place hash/revision update; no `UpsertLink`; no `rfx_event_id` rebind |
