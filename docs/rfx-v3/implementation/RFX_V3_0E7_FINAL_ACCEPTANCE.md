...
Still open after this gate: `FRONTEND_PHASE2_STATUS=IMPLEMENTATION_IN_PROGRESS`, `CREATE_FROM_XLSX_STATUS=NOT_STARTED` (F5 not started), `TRAINING_STATUS=NOT_STARTED`. ERP browser client is forbidden/not started. TMS is out of scope. Award→Transport Order is not part of the E7 browser gate.
