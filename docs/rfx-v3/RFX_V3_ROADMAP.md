...
| **E5 Template Clone + Provenance** | Clone event from template, provenance | **PENDING_CONTROLLER_AUTHORIZATION** |
...
- E5 requires separate controller authorization before implementation.
