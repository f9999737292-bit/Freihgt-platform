...
| **E4 Template Library** | Template library CRUD, publish, fork-draft, archive, draft graph | **IMPLEMENTED_PENDING_CONTROLLER_ACCEPTANCE** |
...
- E4 template library backend is implemented on branch `feat/rfx-template-library-v3.0e4` (migration 000070); pending controller acceptance.
- E5–E7 implementation has not started.
