...
| **v3.0E** | Templates + Versioning | Template library, immutable published versions, compare/restore | **IMPLEMENTATION_IN_PROGRESS** (E1–E5 backend accepted; **E6 frontend** `IMPLEMENTED_PENDING_CONTROLLER_ACCEPTANCE`; E7 not started) |
