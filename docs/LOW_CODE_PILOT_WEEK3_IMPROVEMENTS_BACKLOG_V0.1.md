...
| **Selectel SSH SG Non-Trusted Rejection or Panel Evidence Pack v0.1** | Completed | **SELECTEL_SSH_SG_NON_TRUSTED_REJECTION_FAILED_PORT_22_PUBLICLY_OPEN** |
| **Selectel SSH SG Post-Panel Re-Verification Pack v0.1** | Next | STG-LIM-003 after manual SG /32 change |
