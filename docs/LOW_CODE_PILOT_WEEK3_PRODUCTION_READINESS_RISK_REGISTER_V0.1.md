...
**PR-RISK-001 residual risk:** server not yet provisioned and remote auth-on staging repeat not yet executed.
...
|---------|--------|------|----------|--------|------------|-------|-------------|
| PR-RISK-001 | PR-GAP-001 | Remote Auth-On not repeated on staging | P2 | **BLOCKED_WAITING_FOR_STAGING_SERVER_PROVISIONING** | Server requirements, provider request, and acceptance checklist prepared; intake form and readiness checklist exist; local repeat PASS 2026-06-23 | Ops / Platform / Staging Owner — TBD | Provision staging server, provide details, then run Remote Auth-On Staging Repeat Pack v0.1 |
