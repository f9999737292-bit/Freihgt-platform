...
**Current status:** **TENANT_ISOLATION_EVIDENCE_REVIEWED_PENDING_OWNER_APPROVAL** — controlled pilot **active**; production-ready **not claimed**; PR-GAP-006 **open** (owner approval pending).
