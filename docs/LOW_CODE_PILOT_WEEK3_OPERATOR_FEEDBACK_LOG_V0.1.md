...
**Current status:** **SELECTEL_SSH_SG_POST_PANEL_REVERIFICATION_FAILED_PORT_22_STILL_PUBLIC** — retry #5 (2026-07-12): trusted SSH **FAIL**; external scan **5/5 FAIL**; Bintrans DNS pending in parallel.
