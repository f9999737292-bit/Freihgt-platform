...
**Current status:** **BINTRANS_STAGING_DOMAIN_SELECTED_DNS_PENDING** — Bintrans domain decision finalized; DNS A-record pending operator action; STG-LIM-003 remains open (retry #5 FAIL).
