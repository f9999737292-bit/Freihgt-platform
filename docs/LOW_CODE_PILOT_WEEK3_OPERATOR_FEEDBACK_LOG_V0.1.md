...
**Current status:** **BINTRANS_HTTPS_CERTBOT_PREP_PACK_CREATED_DNS_PENDING** — HTTPS prep docs created; DNS pending; STG-LIM-003 external scan deferred per operator.
