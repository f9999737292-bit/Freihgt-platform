...
| Production deployment execution | **FAIL — initial DNS gate** |
| Production deployment execution retry | **FAIL — server HTTPS verification; rollback PASS** |
| Nginx vhost investigation | **COMPLETE — no production vhost enabled** |
