...
**Current status:** **BINTRANS_STAGING_DOMAIN_SELECTED_DNS_PENDING** — Bintrans staging domain selected; DNS A-record pending operator action; STG-LIM-003 separately open pending SG re-verification.
