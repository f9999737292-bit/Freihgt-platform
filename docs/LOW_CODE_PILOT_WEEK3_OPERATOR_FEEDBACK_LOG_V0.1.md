...
**Current status:** **TENANT_ISOLATION_OWNER_APPROVAL_GATE_PREPARED_PENDING_OWNER_ASSIGNMENT** — controlled pilot **active**; production-ready **not claimed**; PR-GAP-006 **open**.
