...
| ID | Title |
|----|-------|
| [ADR-NET-001](ADR-NET-001-optimization-bounded-context.md) | Optimization bounded context |
| [ADR-NET-002](ADR-NET-002-marketplace-projection-tenant-isolation.md) | Marketplace projection and tenant isolation |
| [ADR-NET-003](ADR-NET-003-capacity-first-class.md) | Capacity as a first-class concept |
| [ADR-NET-004](ADR-NET-004-cargounit-consolidation.md) | CargoUnit and consolidation |
| [ADR-NET-005](ADR-NET-005-route-leg-model.md) | Transport leg and route model |
| [ADR-NET-006](ADR-NET-006-matching-vs-optimization.md) | Matching versus optimization |
| [ADR-NET-007](ADR-NET-007-freight-cost-ownership.md) | Freight cost and RFx ownership |
| [ADR-NET-008](ADR-NET-008-event-driven-reoptimization.md) | Event-driven reoptimization |
| [ADR-NET-009](ADR-NET-009-city-rules.md) | City rules architecture |
