...
**Restore drill status (2026-08-14):** `FAIL` — latest backup (`freight_platform_20260811T083942Z.dump`, 913 bytes) restores to **zero application schemas**. Do **not** rely on this backup for recovery. Fresh backup + isolated drill required before GO.
