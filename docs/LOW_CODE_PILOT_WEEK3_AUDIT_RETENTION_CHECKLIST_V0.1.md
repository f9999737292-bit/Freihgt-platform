...
| Audit/compliance owner assigned | **PASS** | **Феликс Асаев** | Owner Assignment v0.1 | Assigned 2026-06-23 |
| Audit event types defined | **PASS** | PM / Security | Audit Retention Policy v0.1 | In-scope events documented |
| Retention period proposed | **PENDING** | **Феликс Асаев** | Audit Retention Policy v0.1 | Draft 30/90/365 days — pending approval |
...
| Final audit retention approval given | **PENDING** | **Феликс Асаев** | Approval Checklist v0.1 | Final Approval Pack required |
