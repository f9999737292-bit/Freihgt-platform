...
Successful commit returns **200** with `rfx_event_id` and `applied_at`. The event remains **DRAFT** (no auto-publish). Commit revalidates stored baseline tokens `event_row_version`, `draft_row_version`, and `baseline_lots_fingerprint`.
