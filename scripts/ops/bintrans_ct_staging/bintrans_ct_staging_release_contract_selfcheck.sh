...
[[ "${max_target}" == "000079" ]] || fail "expected max migration 000079, got ${max_target}"
...
assert_fail "MIGRATION_TARGET_UNRELEASED_000080" bash -c 'source "'"${ROOT}"'/scripts/ops/bintrans_ct_staging/bintrans_ct_staging_common.sh"; bintrans_validate_migration_target_bounded 000080'
echo "OK: synthetic 36->79 bounded migration contract"
