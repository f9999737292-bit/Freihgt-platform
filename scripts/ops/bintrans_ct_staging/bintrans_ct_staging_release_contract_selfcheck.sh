...
[[ "${max_target}" == "000078" ]] || fail "expected max migration 000078, got ${max_target}"
...
assert_fail "MIGRATION_TARGET_UNRELEASED_000079" bash -c 'source "'"${ROOT}"'/scripts/ops/bintrans_ct_staging/bintrans_ct_staging_common.sh"; bintrans_validate_migration_target_bounded 000079'
echo "OK: synthetic 36->78 bounded migration contract"
