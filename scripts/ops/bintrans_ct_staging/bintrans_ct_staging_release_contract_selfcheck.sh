...
[[ "${max_target}" == "000076" ]] || fail "expected max migration 000076, got ${max_target}"
...
assert_fail "MIGRATION_TARGET_UNRELEASED_000077" bash -c 'source "'"${ROOT}"'/scripts/ops/bintrans_ct_staging/bintrans_ct_staging_common.sh"; bintrans_validate_migration_target_bounded 000077'
echo "OK: synthetic 36->76 bounded migration contract"
