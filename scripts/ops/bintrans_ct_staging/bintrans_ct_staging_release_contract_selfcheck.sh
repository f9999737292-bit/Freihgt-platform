...
[[ "${max_target}" == "000077" ]] || fail "expected max migration 000077, got ${max_target}"
...
assert_fail "MIGRATION_TARGET_UNRELEASED_000078" bash -c 'source "'"${ROOT}"'/scripts/ops/bintrans_ct_staging/bintrans_ct_staging_common.sh"; bintrans_validate_migration_target_bounded 000078'
echo "OK: synthetic 36->77 bounded migration contract"
