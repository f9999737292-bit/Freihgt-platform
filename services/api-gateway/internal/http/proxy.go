...
func NewProxyHandler(cfg config.Config) (*ProxyHandler, error) {
	routeDefs := []struct {
		...
		{"/api/v1/scoring-templates", "rfx-service", cfg.Services.RFX},
		{"/api/v1/allocation-scenarios", "rfx-service", cfg.Services.RFX},
		{"/api/v1/award-proposals", "rfx-service", cfg.Services.RFX},
