...
type awardConversionTOStub struct {
	pool        *pgxpool.Pool
	pricingRepo *repository.PricingRepository
}

func newAwardConversionTOStub(pool *pgxpool.Pool) *awardConversionTOStub {
	return &awardConversionTOStub{pool: pool, pricingRepo: repository.NewPricingRepository(pool)}
}

func (s *awardConversionTOStub) CreateFromAwardScope(ctx context.Context, in transportorderclient.CreateFromAwardScopeRequest) (transportorderclient.CreateFromAwardScopeResponse, error) {
	const existingQuery = `
