...
func startBrowserProductionGateway(t *testing.T, rfxServiceURL, webAdminOrigin string, identity *browserIdentityStub) (string, *browserGatewayProcess) {
	t.Helper()
	root, err := repoRoot()
	if err != nil {
	...
	env := []string{
		...
		"CORS_ALLOWED_ORIGINS=" + webAdminOrigin,
