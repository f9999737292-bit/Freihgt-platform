...
if (!webURL) {
  throw new Error('BROWSER_E2E_WEB_URL is required for human provenance Playwright; silent skip is not allowed')
}
...
export default defineConfig({
  ...
  projects: [
    { name: 'ui-stub', testMatch: 'human-provenance-acceptance.spec.ts' },
    { name: 'live-stack', testMatch: 'human-provenance-live.spec.ts' },
  ],
})
